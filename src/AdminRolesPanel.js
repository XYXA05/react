...
export default function AdminUsersPanel({ token, onBack }) {
  ...
  useEffect(() => {
    ...
    // ← here was the mistake: change PATCH to GET and drop user.id
  ...
  // pick the right base path for each role
  const saveUser = (user, role) => {
    ...
    axios.patch(
      `http://localhost:8000/${base}/${user.id}`,
      user,
      { headers }
    )
    .then(() => alert('✅ Saved'))
    ...
    <div style={{ padding: 20 }}>
      ...
      <section>
        ...
        <table border="1" cellPadding="4">
          <thead>
            <tr>
              <th>ID</th><th>Username</th><th>Name</th><th>Chat ID</th><th>Save</th>
            </tr>
          </thead>
          <tbody>
            {admins.map(u => (
        ...
        <table border="1" cellPadding="4">
          <thead>
            <tr>
              ...
              <th>Admin</th><th>Objects</th><th>Deals</th><th>Save</th>
            </tr>
          </thead>
          <tbody>
            {leaders.map(u => (
      ...
      <section>
        ...
        <table border="1" cellPadding="4">
          <thead>
            <tr>
              <th>ID</th><th>Username</th><th>Name</th><th>Chat ID</th>
              <th>Team Lead</th><th>Objects</th><th>Deals</th><th>Save</th>
            </tr>
          </thead>
          <tbody>
            {realtors.map(u => (
